# src/experiments/lapf_vs_edapf/run_lapf_vs_edapf.py
# cd lapf-ifacjsc2026
...
def main() -> None:
    ...
    particles_hist_No_Ob, weights_hist_No_Ob = run_no_observation(
        config=config,
        T=T,
        M=M,
        A=A,
    ...
    historys.append((particles_hist_No_Ob, weights_hist_No_Ob))

    print("4-1. No Observation filtering done.")
    ...
    print("4-2. EDAPF filtering done.")
    ...
    result_dir = root / "results" / "lapf_vs_edapf"
    result_dir.mkdir(parents=True, exist_ok=True)

    fig_path = result_dir / "lapf_vs_edapf_mse_hist.png"
