# src/experiments/lapf_vs_edapf_under_out-of-domain/run_lapf_vs_edapf_under_out_of_domain.py
# cd lapf-ifacjsc2026
# python -m src.experiments.lapf_vs_edapf_under_out-of-domain.run_lapf_vs_edapf_under_out_of_domain
