...
@dataclass
class ClampedLinearGaussianPFConfig(PFConfig):
    """Configuration for a particle filter for clamped linear Gaussian systems.
...
class ClampedLinearGaussianPF(BaseParticleFilter):
    """Particle filter base class for the clamped linear Gaussian system.
